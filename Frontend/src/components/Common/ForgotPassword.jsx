...
const ForgotPassword = () => {
    ...
    const handleRequestOTP = async (e) => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/api/users/forgot-password/request-otp`, { email });
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/api/users/forgot-password/reset`, {
                email,
                otp,
                newPassword
            });
        ...
        <div className="min-h-screen bg-lv-cream flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="bg-white shadow-xl overflow-hidden">
                    {/* Header with logo */}
                    <div className="bg-lv-dark text-white p-6">
                        <h2 className="text-2xl font-serif font-bold text-center">LOUIS VEIL</h2>
                    </div>

                    {/* Form Content */}
                    <div className="p-6 md:p-8">
                        <div className="mb-6">
                            <Link to="/login" className="flex items-center text-lv-gold hover:text-lv-gold/80">
                        ...
                        {step === 1 ? (
                            <form onSubmit={handleRequestOTP}>
                                ...
                                className="w-full pl-10 pr-3 py-3 border border-gray-300 focus:border-lv-gold focus:ring-1 focus:ring-lv-gold transition-all"
                            ...
                            <form onSubmit={handleResetPassword}>
                                ...
                                <div className="mb-6 flex justify-end">
                                    <button 
                                        ...
                                        className="text-sm text-lv-gold hover:text-lv-gold/80 transition-colors"
                                    >
                                        Resend OTP
                                    </button>
                                </div>
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full bg-lv-dark text-white py-3 font-semibold hover:bg-lv-dark/90 transition-all flex items-center justify-center tracking-wider uppercase"
                                >
                                    {loading ? (
                                        <span className="flex items-center">
                                            <svg className="animate-spin mr-2 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
